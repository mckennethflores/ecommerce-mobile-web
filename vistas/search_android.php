...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../public/css/search_android.css">
  </head>
  <body>
            ...
            <div class="header-cont">
              ...
              <form name="formulario" id="formulario" method="POST">
                        ...
                        <input name="idstore" id="idstore_input" type="hidden" value="<?php echo $idstore; ?>">
                <!-- ******************* Search ******************-->
                <div class="content">
                      <div class="container-product">
                        <div class="search-box"><input type="text" id="nameproduct" name="nameproduct" /><span></span></div>
                      </div>
                      <input style="display:block; margin:0 auto;" type="button" value="Buscar" onclick="buscar_fun()" >
    ...
    <div class="pie-container">
      <div class="pie-item">
        <a href="#" onclick="goBackFunction(<?php echo $idstore ?>)" ><i class="fas fa-home"></i></a></div>
      <div class="pie-item">
        <a href="#"><i class="fas fa-search icon_disabled"></i></a></div>
      <div class="pie-item">
        <a href="#"><i class="fas fa-align-center icon_disabled"></i></a>
      </div>
    </div>
    <script script src="../public/js/jquery-3.3.1.min.js"></script>
    ...
    <script type="text/javascript" src="scripts/search_android.js"></script>
  </body>
</html>