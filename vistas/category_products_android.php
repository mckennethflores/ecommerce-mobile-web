...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../public/css/category_products_android.css">    
  </head>
  <body>
  <!-- HEAD -->
 ...
 <!-- FOOTER -->
    <div class="pie-container">
      <div class="pie-item">
        <a href="#" ><i class="fas fa-home icon_disabled"></i></a>
      </div>
      <div class="pie-item">
        <a href="#" onclick="goSearchFileAndroidFunction(<?php echo $idstore ?>) " ><i class="fas fa-search"></i></a>
      </div>
      <div class="pie-item"> <!-- <a href="#"   ><i class="fas fa-align-center icon_disabled"></i></a> -->
    ...
    <script type="text/javascript" src="scripts/category_products_android.js"></script>
    </body>
  </html>
