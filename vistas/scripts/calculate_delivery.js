...
function init() {
    ...
    $.post("../ajax/calculate_delivery.php?op=selectDistritos&iddepartamento=" + iddepartamento,
        function (values) {
            //    console.log(r);
...
$("#iddistrito").change(function () {
    ...
    if (iddistrito == '16' || iddistrito == '6' || iddistrito == '24' || iddistrito == '29' || iddistrito == '84') {
...
function saveStore(idstore) {
    ...
    $('#iddepartamento_input').val(iddepartamento);
