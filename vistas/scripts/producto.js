...
function init() {
	...
	$.post("../ajax/producto.php?op=selectLinea", function (values) {
		//    console.log(r);
		$("#idlinea").html(values);
	});
	...
	$("#idlinea").change(function () {
		...
		$.post(
			"../ajax/producto.php?op=selectSubLineaCbo&idlinea=" + idlinea,
			function (values) {
