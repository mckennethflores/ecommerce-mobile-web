...
class ProductoAllStore
{
    ...
    public function insertar($idproductosublinea, $idunidadmedida,$nomproductocorto,$codigoBarra,$imagen,$valorventa,$observacion,$idmarca,$preciopromocion,$stockproducto,$idsesiontienda){
        ...
        VALUES('$idproductosublinea','$idunidadmedida','COD','NOM','$nomproductocorto','$codigoBarra','$imagen','IMG_BIG','1','PROV','$valorventa','$observacion','$idmarca','$preciopromocion')";
    ...
    public function editar($idproducto,$idproductosublinea,$idunidadmedida,$nomproductocorto,$codigoBarra,$imagen,$valorventa,$observacion,$idmarca,$preciopromocion,$stockproducto){
        $sql="UPDATE producto SET idproductosublinea='$idproductosublinea',idunidadmedida='$idunidadmedida',nomproductocorto='$nomproductocorto',codigoBarra='$codigoBarra',imagen='$imagen',valorventa='$valorventa',observacion='$observacion',idmarca='$idmarca',preciopromocion='$preciopromocion' WHERE idproducto='$idproducto'";
...
/*     public function mostrar($idproducto){
    ...
    public function mostrar($idproducto){
        ...
        INNER JOIN linea ON sublinea.idproductolinea = linea.idproductolinea WHERE producto.idproducto='$idproducto'";
        return ejecutarConsultaSimpleFila($sql);
    }
